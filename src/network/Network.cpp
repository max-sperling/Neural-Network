...
void Network::propagateBack(const vector<double>& targetVals)
{
...
double Network::getMvAvgError() const
{
    return m_mvAvgError;
}
...
void Network::updateMvAvgError(const vector<double>& targetVals)
{
    ...
    {
        double sFactor = 0.1; // Smoothing factor
